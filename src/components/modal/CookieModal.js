...
const cookieInformation =
  "본 AI 챗봇 서비스는 이전 **대화를 기억**하여 보다 편리한 사용자 경험을 제공하기 위해 쿠키를 사용합니다. 로그인 없이도 대화가 유지되도록 하기 위해 쿠키를 저장하며, 이를 통해 사용자는 이전 대화를 이어갈 수 있습니다.\n" +
  "\n" +
    ...
    <>
      <Wrapper>
        <ContentsBox>
          <TextBox>
            <h1>대화를 시작하기 전에</h1>
            <ReactMarkdown>{cookieInformation}</ReactMarkdown>
          </TextBox>

          <AcceptBtn onClick={acceptAllCookies}>
            <p>모든 쿠키 허용</p>
          </AcceptBtn>
          <SettingBtn onClick={blockCookie}>
            <p>쿠키 차단</p>
          </SettingBtn>
        </ContentsBox>
      </Wrapper>
